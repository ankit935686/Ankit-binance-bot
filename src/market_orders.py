#!/usr/bin/env python3
"""
Market Orders CLI - Simple interface for market orders

This script provides a simple CLI interface for placing market orders.
...
def print_usage():
    ...
    print("  python market_orders.py <SYMBOL> <BUY|SELL> <QUANTITY>")
    print("Example:")
    print("  python market_orders.py BTCUSDT BUY 0.001")
